...
Second, OCR has a range applications -- such as written text to digital transcription --
that could be adapted from the code base we aim to create.
...
functions and performance metrics that are easier to evaluate and control -- allowing
...
\begin{figure}[H]
  ...
  \caption*{Gantt Chart: main tasks of Project Timeline with expected start and completion dates }
\end{figure}
